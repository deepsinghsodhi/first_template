                    ...
                    {/* <NavbarBrand href="/">reactstrap</NavbarBrand> */}
                     <img className='logo' src={logo} alt=' ' />
                        <Nav className="ml-auto" navbar>
                            ...
                            <NavItem>
                                <NavLink style={{color:'black'}} href="https://github.com/reactstrap/reactstrap"><img src="https://img.icons8.com/fluency-systems-regular/28/000000/bag-front-view.png " style={{marginRight:'0.4rem'}}/>Cart</NavLink>
                            </NavItem>
                        </Nav>
                </Navbar>
        </div>
